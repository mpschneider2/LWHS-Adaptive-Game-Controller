...
- [X] Incorporate saving into EEPROM
    - [X] Set default state at start when having empty eeprom
...
- [X] fix left shift—that capital characters are different unicode characters and have different keycodes, as well as left shift translating into an S, as well as cmd key not working
    - [ ] do more exhuastive testing with special characters
    - [ ] TEST ON WINDOWS!!!
- [ ] add reset button functionality
- [ ] Add icon, public page
- [ ] Add error logging/notification
- [ ] Add success logging/notification...